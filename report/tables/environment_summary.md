...
| --- | --- | --- | --- |
| campaign | summary_generated_at_utc | 2026-05-21T12:37:57.900196+00:00 | script timestamp |
...
| host | project_drive_free_bytes | 543172706304 | psutil.disk_usage |
...
| docker_topology | compose_services | hive-metastore, hive-postgres, hiveserver2, spark-core, spark-driver, spark-master, spark-worker-1, spark-worker-2 | docker-compose.yml |
